      ...
      chartDictionaries: {
        zh: {
          ...
          'Annotations are text and arrows you can use to point out specific parts of your figure.':
            '注释是您可以用来指向图表特定部分的文本和箭头。',
          'Click on the + button above to add an annotation.':
            '点击上方的+按钮添加注释。',
          "Looks like there aren't any traces defined yet.":
            '看起来还没有定义任何轨迹。',
          'Go to the Traces panel under Structure to define traces.':
            '转到结构下的轨迹面板来定义轨迹。',
          ...
          'Add shapes to a figure to highlight points or periods in time, thresholds, or areas of interest.':
            '向图表中添加形状以突出显示时间点或时间段、阈值或感兴趣的区域。',
          'Click on the + button above to add a shape.':
            '点击上方的+按钮添加形状。',
          Trace: '轨迹',
          Traces: '轨迹',
          'Add Trace': '添加轨迹',
          ...
          'Embed images in your figure to make the data more readable or to brand your content.':
            '在图表中嵌入图片，使数据更易读或为内容添加品牌标识。',
          'Click on the + button above to add an image.':
            '点击上方的+按钮添加图片。',
          'Drop the image to upload here or click to choose a file from your computer.':
            '拖放图片到此处上传，或点击从您的电脑选择文件。',
          'Supported formats are: JPEG, JPG, SVG, SVG+XML, PNG, GIF, BMP, WEBP.':
            '支持的格式有：JPEG, JPG, SVG, SVG+XML, PNG, GIF, BMP, WEBP。',
          ...
          trace: '轨迹',
          Rendering: '渲染',
          'Drop the geojson to upload here or click to choose a file from your computer.':
            '拖放geojson文件到此处上传，或点击从您的电脑选择文件。',
          'Supported formats are: APPLICATION/JSON.':
            '支持的格式有：APPLICATION/JSON。',
          'Lat/Lon': '经纬度',
          Latitude: '纬度',
          Longitude: '经度',
          Location: '位置',
          ...
          Target: '目标',
          'Click to enter Plot subtitle': '点击输入图表副标题',
          'unrecognized GUI edit: title.subtitle.text':
            '无法识别的GUI编辑：title.subtitle.text',
          Groups: '组',
          Links: '链接',
          Parents: '父级',
          'Collapse All': '全部折叠',
          ...
          'X Axis': 'X轴',
          'Y Axis': 'Y轴',
          'You can style and position your axes in the':
            '您可以在以下位置设置坐标轴样式和位置',
          panel: '面板',
          'You can style and position your axes in the panel.':
            '您可以在面板中设置坐标轴的样式和位置。',
          'You can style and position your axes in the Style panel.':
            '您可以在样式面板中设置坐标轴的样式和位置。',
          'You can style and position your axes in the Axes panel.':
            '您可以在坐标轴面板中设置坐标轴的样式和位置。',
          'You can style and position your axes in the Structure panel.':
            '您可以在结构面板中设置坐标轴的样式和位置。',
          'Trace Opacity': '轨迹透明度',
          'Segment Colors': '分段颜色',
          Colors: '颜色',
          ...
          Template: '模板',
          Value: '值',
          'Inside Text Orientation': '内部文本方向',
          Scaling: '缩放',
          'Scale Group': '缩放组',
          'Hover/Tooltip': '悬停/工具提示',
          'Trace name': '轨迹名称',
          'Clip To': '裁剪到',
          'No Clip': '不裁剪',
